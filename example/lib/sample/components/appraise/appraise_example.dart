          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Text(
                  '支持页面和弹窗使用，页面里使用AuAppraise, 弹窗使用AuAppraiseBottomPicker，picker对widget做了一层封装，两者参数完全一致',
                ),
              ),
              SizedBox(
                height: 20,
              ...
              AuAppraise(
                title: "这里是标题文字",
                headerType: AuAppraiseHeaderType.center,
                type: AuAppraiseType.star,
                tags: tags,
                ...
                config: AuAppraiseConfig(
                    showConfirmButton: false,
                    starAppraiseHint: '星星未选择时的文案',
                    inputDefaultText: '这是一段默认文字',
                    inputTextChangeCallback: (input) {
                      AuToast.show('输入的内容为' + input, context);
                    },
                    iconClickCallback: (index) {
                      AuToast.show('选中的评价为$index', context);
                    },
                    tagSelectCallback: (list) {
                      AuToast.show('选中的标签为:' + list.toString(), context);
                    }),
              ),
              SizedBox(
                height: 50,
