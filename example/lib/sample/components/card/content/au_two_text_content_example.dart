...
class AuTextRIchContentExample extends StatefulWidget {
  @override
  _AuTextRIchContentExampleState createState() =>
      _AuTextRIchContentExampleState();
}

class _AuTextRIchContentExampleState extends State<AuTextRIchContentExample> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            AuRichInfoGrid(
              pairInfoList: <AuRichGridInfo>[
                AuRichGridInfo("名称名称名称名称名称名称名称名称：", '内容内容内容内容'),
                AuRichGridInfo("名称：", '内容内容内容'),
                AuRichGridInfo("名称：", '内容内容'),
                AuRichGridInfo("名称：", '内容'),
              ],
                  ...
                  children: <Widget>[
                    AuPairInfoTable(
                      children: <AuInfoModal>[
                        ...
                        AuInfoModal(keyPart: "名称名：", valuePart: "没加粗的内容"),
                        AuInfoModal(
                    ...
                    AuRichInfoGrid(
                      ...
                      rowSpace: 10,
                      pairInfoList: <AuRichGridInfo>[
                        AuRichGridInfo("正常的名称：", '正常的内容'),
                        AuRichGridInfo(
                            "名称名称名称名称名称名称名称名称名称：", '内容内容内容内容内容内容内容内容内容内容内容'),
                        AuRichGridInfo("名称：", '内容内容内容内容内容内容内容内容内容内容内容内容'),
                        AuRichGridInfo("名称：", ''),
                      ],
                    ),
                    SizedBox(
