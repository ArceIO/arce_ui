...
import 'package:example/sample/components/card/content/au_two_rich_content_example.dart';
import 'package:example/sample/components/card/content/au_two_text_content_example.dart';
import 'package:example/sample/components/card/content/au_two_text_expanded_example.dart';
        ...
        children: [
          ...
          ListItem(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(
                builder: (BuildContext context) {
                  return AuTextRIchContentExample();
                },
              ));
            },
          ),
          ListItem(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(
                builder: (BuildContext context) {
                  return AuTwoRichContentExample();
                },
              ));
            },
          ),
          ...
          ListItem(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(
                builder: (BuildContext context) {
                  return AuTextExpandedContentExample();
                },
              ));
            },
          ),
