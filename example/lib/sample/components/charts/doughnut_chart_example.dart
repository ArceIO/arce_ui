...
class DoughnutChartExampleState extends State<DoughnutChartExample> {
  ...
  List<AuDoughnutDataItem> dataList = [];
  ...
  void initState() {
    ...
    for (int i = 0; i < count; i++) {
      dataList.add(AuDoughnutDataItem(
          title: '示例',
      ...
      body: Column(
        children: <Widget>[
          AuDoughnutChart(
            ...
            selectCallback: (AuDoughnutDataItem? selectedItem) {
              setState(() {
          ...
          DoughnutChartLegend(
              data: this.dataList,
              legendStyle: AuDoughnutChartLegendStyle.wrap),
          Row(
