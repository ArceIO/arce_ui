...
class _BrokenLineExampleState extends State<BrokenLineExample> {
  ...
  List<AuPointData> _linePointsForExample1(List<DBDataNodeModel> brokenData) {
    return brokenData
        .map((_) => AuPointData(
            pointText: _.value,
            x: brokenData.indexOf(_).toDouble(),
            y: double.parse(_.value!),
            lineTouchData: AuLineTouchData(
  ...
  List<AuDialItem> _getYDialValuesForExample1(
    ...
    List<AuDialItem> _yDialValue = [];
    for (int index = 0; index <= 10; index++) {
      _yDialValue.add(AuDialItem(
  ...
  List<AuDialItem> _getXDialValuesForExample1(
      List<DBDataNodeModel> brokenData) {
    List<AuDialItem> _xDialValue = [];
    for (int index = 0; index < brokenData.length; index++) {
      _xDialValue.add(AuDialItem(
  ...
  List<AuPointsLine> _linesForExample2() {
    AuPointsLine _pointsLine;
    AuPointsLine _pointsLine1;
    List<AuPointsLine> pointsLineList = [];
    _pointsLine = AuPointsLine(
      isShowPointText: true,
      lineWidth: 3,
      pointRadius: 4,
      isShowPoint: false,
  ...
  List<AuDialItem> _xDialValuesForExample2() {
    return [
      AuDialItem(
        dialText: '1月',
        dialTextStyle: TextStyle(fontSize: 12.0, color: Color(0xFF999999)),
  ...
  List<AuDialItem> _yDialValuesForExample2() {
    return [
      AuDialItem(
        dialText: '0',
        dialTextStyle: TextStyle(fontSize: 12.0, color: Color(0xFF999999)),
  ...
  List<AuPointsLine> _getPointsLinesForExample3() {
    AuPointsLine pointsLine, _pointsLine2;
    List<AuPointsLine> pointsLineList = [];
    pointsLine = AuPointsLine(
      lineWidth: 3,
      pointRadius: 4,
      isShowPoint: true,
      isCurve: false,
  ...
  List<AuDialItem> getYDialValuesForExample3() {
    return [
      AuDialItem(
        dialText: '自定义',
  ...
  _getXDialValuesForExample3(List<AuPointsLine> lines) {
    List<AuDialItem> _xDialValue = [];
  ...
  List<AuPointsLine> _getPointsLinesForExample4() {
    AuPointsLine pointsLine, _pointsLine2;
    List<AuPointsLine> pointsLineList = [];
    pointsLine = AuPointsLine(
      lineWidth: 3,
  ...
  List<AuDialItem> _yDialValuesForExample4() {
    return [
      AuDialItem(
        dialText: '0',
        dialTextStyle: TextStyle(fontSize: 12.0, color: Color(0xFF999999)),
  ...
  List<AuDialItem> _getXDialValuesForExample4(List<AuPointsLine> lines) {
    List<AuDialItem> _xDialValue = [];
    for (int index = 0; index < lines[0].points.length; index++) {
      _xDialValue.add(AuDialItem(
        dialText: '${lines[0].points[index].x}',
...
///////////////////////
  ...
  List<AuDialItem> _yDialValuesForExample5() {
    return [
      AuDialItem(
        dialText: '0',
        dialTextStyle: TextStyle(fontSize: 12.0, color: Color(0xFF999999)),
  ...
  _getXDialValuesForExample5(List<AuPointsLine> lines) {
    List<AuDialItem> _xDialValue = [];
    for (int index = 0; index < lines[0].points.length; index++) {
      _xDialValue.add(AuDialItem(
        dialText: '${lines[0].points[index].x}',
  ...
  List<AuPointsLine> _getPointsLineListWithShowPointText() {
    AuPointsLine pointsLine, _pointsLine2;
    List<AuPointsLine> pointsLineList = [];
    pointsLine = AuPointsLine(
      lineWidth: 3,
  ...
  Widget _buildIdentificationList() {
    ...
    for (AuPointsLine bean in _getPointsLinesForExample3()) {
