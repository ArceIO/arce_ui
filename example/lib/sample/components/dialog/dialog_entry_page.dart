...
class DialogEntryPage extends StatelessWidget {
        ...
        body: ListView(
          children: <Widget>[
            ...
            ListItem(
              ...
              onPressed: () {
                _showAuOneVerticalButtonDialogDialog(context);
              },
            ),
            ListItem(
              ...
              isSupportTheme: true,
              onPressed: () {
                _showAuTwoVerticalButtonDialogDialog(context);
              },
            ),
            ListItem(
              title: "纯文本弹框",
  ...
  void _showStyle5_1Dialog(BuildContext context) {
    AuDialogManager.showMoreButtonDialog(context,
        actions: [
          '选项一',
          '选项二',
          '选项三',
  ...
  ///底部有输入框弹框
  void _showAuLoadingDialog(BuildContext context) {
    AuLoadingDialog.show(context).then((value) {
      AuToast.show('result: $value', context);
    });
    Future.delayed(Duration(seconds: 5)).then((_) {
      AuLoadingDialog.dismiss(context, 'dismiss 定时取消');
    });
  }
  ...
  void _showSafeDialog(BuildContext context) {
    AuSafeDialog.show(
      ...
      AuToast.show('result: $result ', context);
    });
  ...
  void _showAuShareDialog3(BuildContext context) {
    AuShareDialog brnShareDialog = new AuShareDialog(
      context: context,
      shareChannels: [
      ...
      clickCallBack: (int channel, int index) {
        AuToast.show("channel: $channel, index: $index", context);
      },
  ...
  void _showAuShareDialog5(BuildContext context) {
    AuShareDialog brnShareDialog = new AuShareDialog(
      context: context,
      shareChannels: [
        AuShareItemConstants.shareWeiXin,
  ...
  void _showAuTwoVerticalButtonDialogDialog(BuildContext context) {
    AuEnhanceOperationDialog brnShareDialog = new AuEnhanceOperationDialog(
      context: context,
      iconType: AuDialogConstants.iconAlert,
      titleText: "强提示文案",
  ...
  void _showAuOneVerticalButtonDialogDialog(BuildContext context) {
    AuEnhanceOperationDialog brnShareDialog = new AuEnhanceOperationDialog(
      iconType: AuDialogConstants.iconWarning,
      context: context,
      titleText: "强提示文案",
      descText: "这里是文案这里是文案这里是文案这里是文案这里是文案这里是文案这里是文案这里是文案",
      mainButtonText: "我知道了",
  ...
  void _showStyle82Dialog(BuildContext context) {
    showDialog(
        context: context,
        builder: (_) => AuScrollableTextDialog(
            title: "纯文本标题",
            contentText:
