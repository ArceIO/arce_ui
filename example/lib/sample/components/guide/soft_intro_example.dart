  ...
  _SoftGuideExampleState() {
    ...
    intro = AuGuide(
      ...
      widgetBuilder: StepWidgetBuilder.useDefaultTheme(
        tipInfo: [
          AuTipInfoBean("标题栏", "这里是标题栏，显示当前页面的名称", ""),
          AuTipInfoBean("标签组件", "这里是标签组件，你可以动态添加或者删除组件，当你点击后会将结果给你回传", ""),
          AuTipInfoBean("左边的按钮", "这里是按钮，点击他试试", ""),
          AuTipInfoBean("右边的按钮", "这里是按钮，点击他试试", ""),
          AuTipInfoBean("左边的文本 ", "这是一个朴实无华的文本", ""),
          AuTipInfoBean("右边文本 ", "这是一个枯燥文本", ""),
          AuTipInfoBean("开始按钮 ", "点击开启引导动画", ""),
        ],
      ),
    );
  }
            ...
            child: Column(
              ...
              children: [
                ...
                AuSelectTag(
                    ...
                    fixWidthMode: false,
                    onSelect: (index) {
                      AuToast.show("$index is selected", context);
                    }),
                SizedBox(
                  height: 16,
                ),
