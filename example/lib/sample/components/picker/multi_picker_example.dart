...
class MultiPickerExamplePage extends StatelessWidget {
            ...
            ListItem(
              ...
              onPressed: () {
                AuMultiDataPicker(
                  context: context,
                  title: '来源',
                  delegate: Au1RowDelegate(firstSelectedIndex: 1),
                  confirmClick: (list) {
                    AuToast.show(list.toString(), context);
                  },
                ).show();
              },
            ),
            ...
            ListItem(
              ...
              onPressed: () {
                AuMultiDataPicker(
                  context: context,
                  title: '来源',
                  delegate: AuDefaultMultiDataPickerDelegate(
  ...
  List<AuMultiDataPickerEntity> _getDefaultDelegateData() {
    AuMultiDataPickerEntity data = AuMultiDataPickerEntity(
        text: '测试1', value: 5095791542795657, children: []);

    AuMultiDataPickerEntity data2 = AuMultiDataPickerEntity(
        text: '测试2', value: 5029051542795656, children: []);

    AuMultiDataPickerEntity data3 = AuMultiDataPickerEntity(
...
class Au1RowDelegate implements AuMultiDataPickerDelegate {
  int firstSelectedIndex = 0;
  int secondSelectedIndex = 0;
  int thirdSelectedIndex = 0;

  Au1RowDelegate({this.firstSelectedIndex = 0, this.secondSelectedIndex = 0});
...
class Au2RowDelegate implements AuMultiDataPickerDelegate {
  int firstSelectedIndex = 0;
  int secondSelectedIndex = 0;
  int thirdSelectedIndex = 0;

  Au2RowDelegate({this.firstSelectedIndex = 0, this.secondSelectedIndex = 0});
...
class Au3RowDelegate implements AuMultiDataPickerDelegate {
  int firstSelectedIndex = 0;
  int secondSelectedIndex = 0;
  int thirdSelectedIndex = 0;
...
class Au2RowCustomDelegate implements AuMultiDataPickerDelegate {
  int firstSelectedIndex = 0;
  int secondSelectedIndex = 0;

  Au2RowCustomDelegate(
