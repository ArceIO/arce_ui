            ...
            ListItem(
              ...
              onPressed: () {
                rootBundle
                    ...
                    .then((data) {
                  var datas = AuFilterEntity.fromJson(
              ...
              onPressed: () {
                rootBundle
                  ...
                  var page = SelectionViewMultiListExamplePage(
                      ...
                      AuSelectionEntityListBean.fromJson(
            ...
            ListItem(
              ...
              onPressed: () {
                rootBundle
                    ...
                    .then((data) {
                  var datas = AuSelectionEntityListBean.fromJson(
                          JsonDecoder().convert(data)["data"])!
                      .list!;
                  datas.removeAt(0);
                  datas.removeAt(1);
                  void _configMaxSelectedCount(
                      AuSelectionEntity entity, int maxCount) {
