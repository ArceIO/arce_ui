...
class _SelectionViewExamplePageState
  ...
  List<AuSelectionEntity>? _filterData;
  ...
  OverlayEntry getCustomFilterView() {
    ...
    AuSelectionListViewController controller = AuSelectionListViewController();
    ...
    OverlayEntry entry = OverlayEntry(builder: (context) {
      return GestureDetector(
        ...
        child: Container(
          ...
          child: Stack(
            children: <Widget>[
              AuSelectionAnimationWidget(controller: controller, view: content)
            ],
          ),
        ),
      );
