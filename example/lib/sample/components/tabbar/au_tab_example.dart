...
import 'au_tabbar_sticky_example.dart';

class AuTabExample extends StatefulWidget {
  @override
  _AuTabExampleState createState() => _AuTabExampleState();
}

class _AuTabExampleState extends State<AuTabExample>
    with TickerProviderStateMixin {
  AuCloseWindowController? closeWindowController;

  @override
  void initState() {
    super.initState();
    closeWindowController = AuCloseWindowController();
  }
