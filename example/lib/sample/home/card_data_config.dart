...
import 'package:example/sample/components/card/au_shadow_example.dart';
...
import 'package:example/sample/components/charts/line/au_broken_line_example.dart';
...
import 'package:example/sample/components/noticebar/au_notice_bar_example.dart';
...
import 'package:example/sample/components/switch/au_switch_example.dart';
...
import 'package:example/sample/components/tabbar/au_tab_example.dart';
...
class CardDataConfig {
  ...
  static Widget _buildSingleSelectCityPage() {
    List<AuSelectCityModel> hotCityList = [];
    hotCityList.addAll([
      AuSelectCityModel(name: "北京市"),
      AuSelectCityModel(name: "广州市"),
      AuSelectCityModel(name: "成都市"),
      AuSelectCityModel(name: "深圳市"),
      AuSelectCityModel(name: "杭州市"),
      AuSelectCityModel(name: "武汉市"),
    ]);
    return AuSingleSelectCityPage(
      appBarTitle: '城市单选',
