import 'package:arce_ui/src/components/button/au_vertical_icon_button.dart';
...
///
/// 相关按钮如下:
///  * [AuButtonPanel], 小主次按钮组成的横向面板
///  * [AuMultipleBottomButton], 具备编辑选择状态的底部操作按钮
///  * [AuTextButtonPanel], 平分可用空间的文本按钮面板
///  * [AuVerticalIconButton], 小主次按钮组成的横向面板
///
class AuBottomButtonPanel extends StatelessWidget {
  /// 主按钮的文案
  ...
  /// icon按钮的集合
  final List<AuVerticalIconButton>? iconButtonList;
  ...
  /// create AuBottomButtonPanel
  const AuBottomButtonPanel(
      {super.key,
