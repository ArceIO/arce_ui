...
class AuCalendarView extends StatefulWidget {
  const AuCalendarView(
      {super.key,
...
class _CustomCalendarViewState extends State<AuCalendarView> {
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: isPreIconEnable
                    ? BrunoTools.getAssetImage(AuAsset.iconCalendarPreMonth)
                    : BrunoTools.getAssetImageWithColor(
                        AuAsset.iconCalendarPreMonth, const Color(0xFFCCCCCC)),
              ),
            ),
            Expanded(
              child: Center(
                child: Text(
                  DateFormat(
                          AuIntl.of(context).localizedResource.dateFormatYYYYMM)
                      .format(_currentDate),
                  style: TextStyle(
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: isNextIconEnable
                    ? BrunoTools.getAssetImage(AuAsset.iconCalendarNextMonth)
                    : BrunoTools.getAssetImageWithColor(
                        AuAsset.iconCalendarNextMonth, const Color(0xFFCCCCCC)),
              ),
            )
          ],
        ),
  ...
  String _getChinaWeekName(int weekOfDay) {
    return (widget.weekNames ??
        AuIntl.of(context).localizedResource.weekMinName)[weekOfDay];
  }
}
