...
///
/// 相关按钮如下:
///  * [AuCommonCardTitle], 普通卡片标题组件
///
class AuActionCardTitle extends StatelessWidget {
  ///标题显示文案：必填参数
  final String title;
  ...
  /// create AuActionCardTitle
  const AuActionCardTitle({
    super.key,
    required this.title,
    this.accessoryText,
    this.onTap,
  ...
  Widget _titleWidget(AuCardTitleConfig defaultConfig) {
    return Container(
  ...
  Widget _sub(AuCardTitleConfig defaultConfig) {
  ...
  Widget _arrowWidget() {
    return BrunoTools.getAssetSizeImage(AuAsset.iconRightArrow, 16, 16);
  }
  ...
  //标题右侧的小文字 样式
  TextStyle _subTextStyle(AuCardTitleConfig defaultConfig) =>
