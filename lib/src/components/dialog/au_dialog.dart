...
///  }
///
class AuDialog extends AlertDialog {
  /// 标题控件
  ...
  /// dialog配置
  final AuDialogConfig? themeData;
  ...
  Widget build(BuildContext context) {
    AuDialogConfig? defaultConfig = themeData ?? AuDialogConfig();
            ...
            child: Material(
              shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.all(Radius.circular(
                      AuDialogUtils.getDialogRadius(defaultConfig)))),
  ...
  Widget _generateIconWidget(
      BuildContext context, AuDialogConfig dialogConfig) {
  ...
  Widget _generateTitleWidget(
    ...
    if (titleWidget != null) {
      return DefaultTextStyle(
        ...
        style: AuDialogUtils.getDialogTitleStyle(dialogConfig),
        child: titleWidget!,
      );
    }
  ...
  Widget _generateMainWidget(Widget widget, Color background, _ButtonType type,
      int index, AuDialogConfig dialogConfig) {
    return Container(
          ...
          shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.only(
                  bottomLeft: Radius.circular(type == _ButtonType.single ||
                      ...
                      ? AuDialogUtils.getDialogRadius(dialogConfig)
                      : 0),
  ...
  Widget _generateActionsWidget(
      BuildContext context, AuDialogConfig defaultConfig) {
  ...
  Widget _mapTextToGesWidget(BuildContext context, String label, int index,
      bool main, AuDialogConfig dialogConfig,
  ...
  /// 主题配置的标题间距
  EdgeInsetsGeometry _configTitlePadding(AuDialogConfig dialogConfig) {
    return _isShowIcon()
  ...
  /// 主题配置的内容间距
  EdgeInsetsGeometry _configContentPadding(AuDialogConfig dialogConfig) {
  ...
  /// 主题配置的警告间距
  EdgeInsetsGeometry _configWarningPadding(AuDialogConfig dialogConfig) {
