...
class AuMiddleInputDialog {
  ...
  void _doShow(BuildContext context) {
    ...
    return AuDialogManager.showConfirmDialog(context,
        cancel: cancelText ?? AuIntl.of(context).localizedResource.cancel,
        confirm: confirmText ?? AuIntl.of(context).localizedResource.ok,
        title: title,
