import 'package:arce_ui/src/components/dialog/au_content_export_dialog.dart';
...
typedef AuMultiSelectDialogClickSubmitCallback = bool Function(
    List<MultiSelectItem> data);
typedef AuMultiSelectDialogOnItemClickCallback = void Function(
...
class AuMultiSelectDialog extends Dialog {
  /// 是否可关闭  默认true 可关闭
  final bool isClose;
  ...
  /// 点击操作按钮
  final AuMultiSelectDialogClickSubmitCallback? onSubmitClick;

  /// 点击选项操作 可供埋点需求用
  final AuMultiSelectDialogOnItemClickCallback? onItemClick;
  ...
  const AuMultiSelectDialog({super.key, 
    this.isClose = true,
    this.title = "",
  ...
  Widget _generateContentWidget() {
    ...
    if (!BrunoTools.isEmpty(widget.messageText)) {
      return Padding(
        ...
        child: Text(
          widget.messageText!,
          style: AuThemeConfigurator.instance
              .getConfig()
              .dialogConfig
              .contentTextStyle
              .generateTextStyle(),
