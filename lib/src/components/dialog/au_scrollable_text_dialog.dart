...
///  纯文本展示Dialog 超过定高可滚动
///  可有操作区域也可没有皂搓区域
class AuScrollableTextDialog extends Dialog {
  /// 标题
  final String? title;
  ...
  /// 富文本超链接点击回调
  final AuHyperLinkCallback? linksCallback;

  /// 是否展示底部操作区域 默认true展示
  final bool isShowOperateWidget;

  const AuScrollableTextDialog(
...
class AuScrollableText extends StatelessWidget {
  /// 标题
  final String? title;
            ...
            child: Padding(
              ...
              child: SingleChildScrollView(
                child:
                  ...
                  AuCSS2Text.toTextView(contentText,
                      linksCallback: linksCallback,
