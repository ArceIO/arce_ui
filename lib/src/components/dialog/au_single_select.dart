...
import 'au_dialog.dart';

typedef AuSingleSelectOnSubmitCallback = Function(String? data);
typedef AuSingleSelectOnItemClickCallback = void Function(
    BuildContext dialogContext, int index);

/// 单选列表弹框
class AuSingleSelectDialog extends Dialog {
  ...
  /// 提交按钮点击回调
  final AuSingleSelectOnSubmitCallback? onSubmitClick;

  /// item 点击回调
  final AuSingleSelectOnItemClickCallback? onItemClick;
  ...
  const AuSingleSelectDialog(
      {super.key, this.isClose = true,
      this.title = "",
      this.messageText,
      this.messageWidget,
  ...
  Widget build(BuildContext context) {
    return AuSingleSelectDialogWidget(
      isClose: isClose,
      title: title,
      messageText: messageText,
      messageWidget: messageWidget,
      conditions: conditions,
      submitText: submitText ?? AuIntl.of(context).localizedResource.submit,
...
class AuSingleSelectDialogWidget extends StatefulWidget {
  final bool isClose;
  final String title;
  final String? messageText;
  final Widget? messageWidget;
  ...
  final String submitText;
  final AuSingleSelectOnSubmitCallback? onSubmitClick;
  final AuSingleSelectOnItemClickCallback? onItemClick; //可供埋点需求用
  final Color? submitBgColor;
  ...
  State<StatefulWidget> createState() {
    return AuSingleSelectDialogWidgetState();
  }
}

class AuSingleSelectDialogWidgetState
    extends State<AuSingleSelectDialogWidget> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text(
                          widget.title,
                          style: AuDialogUtils.getDialogTitleStyle(
                              widget.themeData!),
                        ),
                      ),
