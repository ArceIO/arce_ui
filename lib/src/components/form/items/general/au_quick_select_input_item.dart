...
class AuTextQuickSelectFormItem extends StatefulWidget {
  ...
  @override
  AuTextQuickSelectFormItemState createState() {
    return AuTextQuickSelectFormItemState();
  }
}

class AuTextQuickSelectFormItemState extends State<AuTextQuickSelectFormItem> {
  @override
  ...
  Widget buildText() {
    if (widget.value != null && widget.value!.isNotEmpty) {
      ...
      return Text(
        ...
        textAlign: TextAlign.end,
        style: AuFormUtil.getHintTextStyle(widget.themeData!),
      );
    }
  }
}
