...
class AuRadioInputFormItem extends StatefulWidget {
  ...
  @override
  AuRadioInputFormItemState createState() {
    return AuRadioInputFormItemState();
  }
}

class AuRadioInputFormItemState extends State<AuRadioInputFormItem> {
    ...
    if (options != null && options.isNotEmpty) {
      ...
      for (String? item in options) {
        ...
        double optionWidth = painter.width +
            AuFormUtil.optionsMiddlePadding(widget.themeData!)!.left +
