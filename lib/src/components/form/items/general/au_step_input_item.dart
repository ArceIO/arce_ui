...
class AuStepInputFormItem extends StatefulWidget {
  ...
  @override
  AuStepInputFormItemState createState() {
    return AuStepInputFormItemState();
  }
}

class AuStepInputFormItemState extends State<AuStepInputFormItem> {
  ...
  Image _getAddIcon() {
    if (!widget.isEdit) {
      return BrunoTools.getAssetImage(AuAsset.iconAddDisable);
    }
    ...
    return BrunoTools.getAssetImage(AuAsset.iconAddEnable);
  }
  ...
  Image _getMinusIcon() {
    if (!widget.isEdit) {
      return BrunoTools.getAssetImage(AuAsset.iconMinusDisable);
    }
    ...
    return BrunoTools.getAssetImage(AuAsset.iconMinusEnable);
  }
