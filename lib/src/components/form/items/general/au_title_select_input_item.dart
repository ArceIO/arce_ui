...
class AuTitleSelectInputFormItem extends StatefulWidget {
  ...
  /// title文案选中回调
  final OnAuFormTitleSelected? onTitleSelected;
  ...
  AuTitleSelectInputFormItem(
      ...
      this.hint,
      this.maxCount,
      this.inputType = AuInputType.text,
  ...
  @override
  AuTitleSelectInputFormItemState createState() =>
      AuTitleSelectInputFormItemState();
}

class AuTitleSelectInputFormItemState
    extends State<AuTitleSelectInputFormItem> {
  ...
  Widget _buildTextField() {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        hintText:
            widget.hint ?? AuIntl.of(context).localizedResource.pleaseEnter,
        counterText: "",
