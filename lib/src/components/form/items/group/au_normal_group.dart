...
class AuNormalFormGroup extends StatefulWidget {
  ...
  @override
  AuNormalFormGroupState createState() {
    return AuNormalFormGroupState();
  }
}

class AuNormalFormGroupState extends State<AuNormalFormGroup> {
  @override
  void initState() {
    super.initState();
  }
