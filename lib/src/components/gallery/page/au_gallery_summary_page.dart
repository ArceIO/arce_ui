...
import 'package:arce_ui/src/components/gallery/page/au_gallery_detail_page.dart';
import 'package:arce_ui/src/components/navbar/au_appbar.dart';
import 'package:arce_ui/src/components/scroll_anchor/au_scroll_anchor_tab.dart';
...
class AuGallerySummaryPage extends StatefulWidget {
  /// 显示的所有配置信息
  ...
  @override
  _AuGallerySummaryPageState createState() => _AuGallerySummaryPageState();
}

class _AuGallerySummaryPageState extends State<AuGallerySummaryPage> {
  @override
  void initState() {
    super.initState();
  ...
  @override
  void didUpdateWidget(AuGallerySummaryPage oldWidget) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AuAppBar(
        title: AuIntl.of(context).localizedResource.allPics,
      ),
  ...
  Widget _body() {
    List<AuBasicGroupConfig> allConfig = widget.allConfig;
  ...
  Widget _buildItem(AuBasicGroupConfig? groupConfig, int groupId) {
