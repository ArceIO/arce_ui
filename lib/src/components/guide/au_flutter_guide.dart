...
import 'package:arce_ui/src/components/guide/au_pulse_widget.dart';
import 'package:arce_ui/src/components/guide/au_tip_widget.dart';
import 'package:flutter/material.dart';

part 'au_delay_rendered_widget.dart';
part 'au_step_widget_builder.dart';
part 'au_step_widget_params.dart';
part 'au_throttling.dart';
...
class AuTipInfoBean {
  ...
  AuTipInfoBean(this.title, this.message, this.imgUrl);
}
