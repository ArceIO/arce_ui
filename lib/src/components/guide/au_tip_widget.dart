import 'package:arce_ui/src/components/button/au_icon_button.dart';
import 'package:arce_ui/src/components/guide/au_flutter_guide.dart';
...
/// 默认的引导组件包含，强和弱两种交互模式
class AuTipInfoWidget extends StatelessWidget {
  /// 引导组件的方向
            ...
            child: onClose == null
                ...
                : GestureDetector(
                    ...
                    child: BrunoTools.getAssetImageWithColor(
                        AuAsset.iconClose, Colors.black),
                  ),
          ),
        ],
      ),
                ...
                ? GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: GestureDetector(
                        ...
                        child: Text(
                          '${AuIntl.of(context).localizedResource.skip} (${currentStepIndex + 1}/$stepCount)',
                          style:
                        ...
                        child: Text(
                          nextTip ??
                              (stepCount == currentStepIndex + 1
                                  ? AuIntl.of(context).localizedResource.known
                                  : AuIntl.of(context).localizedResource.next),
