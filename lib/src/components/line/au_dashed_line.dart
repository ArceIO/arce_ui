...
/// 默认位置，头部
const AuDashedLinePosition _normalPosition = AuDashedLinePosition.leading;

/// 虚线分割线
class AuDashedLine extends StatelessWidget {
  ...
  final AuDashedLinePosition position;
...
class AuDashedPainter extends CustomPainter {
  /// 虚线方向
  final Axis axis;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (axis == Axis.horizontal) {
      ...
      double height = 0;
      if (position == AuDashedLinePosition.leading) {
        // 头部
