import 'package:arce_ui/src/components/noticebar/au_marquee_text.dart';
...
class AuNoticeBar extends StatelessWidget {
  /// 自定义左边的图标
...
class NoticeStyles {
  ...
  static NoticeStyle failWithArrow = NoticeStyle(
      BrunoTools.getAssetImage(AuAsset.iconNoticeFail),
      const Color(0xFFFA3F3F),
      const Color(0xFFFEEDED),
      BrunoTools.getAssetImage(AuAsset.iconNoticeArrowRed));
  ...
  static NoticeStyle failWithClose = NoticeStyle(
      ...
      const Color(0xFFFA3F3F),
      const Color(0xFFFEEDED),
      BrunoTools.getAssetImage(AuAsset.iconNoticeCloseRed));

  ///蓝色+进行中+箭头
  static NoticeStyle runningWithArrow = NoticeStyle(
      BrunoTools.getAssetImage(AuAsset.iconNoticeRunning),
      const Color(0xFF0984F9),
      const Color(0xFFE0EDFF),
      BrunoTools.getAssetImage(AuAsset.iconNoticeArrowBlue));
  ...
  static NoticeStyle runningWithClose = NoticeStyle(
      ...
      const Color(0xFF0984F9),
      const Color(0xFFE0EDFF),
      BrunoTools.getAssetImage(AuAsset.iconNoticeCloseBlue));

  ///绿色+完成+箭头
  static NoticeStyle succeedWithArrow = NoticeStyle(
      BrunoTools.getAssetImage(AuAsset.iconNoticeSucceed),
      const Color(0xFF00AE66),
      const Color(0xFFEBFFF7),
      BrunoTools.getAssetImage(AuAsset.iconNoticeArrowGreen));
  ...
  static NoticeStyle succeedWithClose = NoticeStyle(
      ...
      const Color(0xFF00AE66),
      const Color(0xFFEBFFF7),
      BrunoTools.getAssetImage(AuAsset.iconNoticeCloseGreen));

  ///橘色+警告+箭头
  static NoticeStyle warningWithArrow = NoticeStyle(
      BrunoTools.getAssetImage(AuAsset.iconNoticeWarning),
      const Color(0xFFFAAD14),
      const Color(0xFFFDFCEC),
      BrunoTools.getAssetImage(AuAsset.iconNoticeArrowOrange));
  ...
  static NoticeStyle warningWithClose = NoticeStyle(
      ...
      const Color(0xFFFAAD14),
      const Color(0xFFFDFCEC),
      BrunoTools.getAssetImage(AuAsset.iconNoticeCloseOrange));

  ///橘色+通知+箭头
  static NoticeStyle normalNoticeWithArrow = NoticeStyle(
      BrunoTools.getAssetImage(AuAsset.iconNotice),
      const Color(0xFFFAAD14),
      const Color(0xFFFDFCEC),
      BrunoTools.getAssetImage(AuAsset.iconNoticeArrowOrange));
