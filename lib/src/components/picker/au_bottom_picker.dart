  ...
  static void show(
    ...
    showGeneralDialog(
      ...
      pageBuilder: (BuildContext buildContext, Animation<double> animation,
        ...
        final Widget pageChild = AuBottomPickerWidget(
...
class AuBottomPickerWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return AuBottomPickerWidgetState();
  }
}

class AuBottomPickerWidgetState extends State<AuBottomPickerWidget>
  ...
  Widget? _buildConfirmWidget() {
    ...
    if (widget.confirm is Widget) {
      ...
      confirmWidget =
          _buildDefaultConfirm(AuIntl.of(context).localizedResource.confirm);
    }
  ...
  Widget? _buildCancelWidget() {
    ...
    if (widget.cancel is Widget) {
      ...
      cancelWidget =
          _buildDefaultCancel(AuIntl.of(context).localizedResource.cancel);
    }
    return cancelWidget;
  }
  ...
  Widget _buildDefaultCancel(String? string) {
    return Text(
      string ?? AuIntl.of(context).localizedResource.cancel,
      style: TextStyle(
          color: AuThemeConfigurator.instance
              .getConfig()
              .commonConfig
