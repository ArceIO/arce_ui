...
import 'package:arce_ui/src/components/picker/time_picker/date_range_picker/au_date_range_picker.dart';
...
class DateTimeFormatter {
  ...
  static String generateDateFormat(
      String? dateFormat, AuDateTimePickerMode pickerMode) {
  ...
  static String generateDateRangePickerFormat(
      String? dateFormat, AuDateTimeRangePickerMode pickerMode) {
    if (dateFormat != null && dateFormat.isNotEmpty) {
      return dateFormat;
    }
    switch (pickerMode) {
  ...
  static String _formatMonth(int value, String format) {
    List<String> months = AuIntl.currentResource.months;
  ...
  static String _formatWeek(int value, String format) {
    if (format.contains('EEEE')) {
      ...
      List<String> weeks = AuIntl.currentResource.weekFullName;
      return format.replaceAll('EEEE', weeks[value - 1]);
    }
    // EEE: the short name of week, e.g. Mon
    List<String> weeks = AuIntl.currentResource.weekShortName;
