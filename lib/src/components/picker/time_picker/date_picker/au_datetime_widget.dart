...
class AuDateTimeWidget extends StatefulWidget {
  AuDateTimeWidget({
    super.key,
    this.minDateTime,
    this.maxDateTime,
  ...
  @override
  State<StatefulWidget> createState() => _AuDateTimeWidgetState(
      minDateTime, maxDateTime, initDateTime, minuteDivider);
}

class _AuDateTimeWidgetState extends State<AuDateTimeWidget> {
  ...
  _AuDateTimeWidgetState(DateTime? minTime, DateTime? maxTime,
