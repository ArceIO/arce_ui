...
/// AuTimeWidget widget. Can display time picker
// ignore: must_be_immutable
class AuTimeWidget extends StatefulWidget {
  AuTimeWidget({
    super.key,
    this.minDateTime,
    this.maxDateTime,
  ...
  @override
  State<StatefulWidget> createState() => _AuTimeWidgetState(minDateTime,
      maxDateTime, initDateTime, minuteDivider);
}

class _AuTimeWidgetState extends State<AuTimeWidget> {
  ...
  _AuTimeWidgetState(DateTime? minTime, DateTime? maxTime, DateTime? initTime,
      int? minuteDivider) {
  ...
  Widget _renderPickerView(BuildContext context) {
    ...
    if (widget.pickerTitleConfig.title != null ||
      ...
      Widget titleWidget = AuPickerTitle(
