...
import 'package:arce_ui/src/components/picker/time_picker/date_range_picker/au_date_range_widget.dart';
import 'package:arce_ui/src/components/picker/time_picker/date_range_picker/au_time_range_widget.dart';
import 'package:arce_ui/src/theme/au_theme.dart';
import 'package:arce_ui/src/utils/i18n/au_date_picker_i18n.dart';
import 'package:flutter/material.dart';

/// 时间范围选择展示模式
enum AuDateTimeRangePickerMode {
  /// 日期模式，仅展示到 月、日
  date,
...
/// 从底部弹出时间范围选择 Picker
class AuDateRangePicker {
  /// isDismissible[bool]点击背景是否自动消失
  /// minDateTime: [DateTime] 可选的最小时间
  /// maxDateTime: [DateTime] 可选的最大时间
  /// isLimitTimeRange: [bool] 是否显示开始时间必须小于等于结束时间，默认为 true，仅在 [AuDateTimeRangePickerMode] 为 time 时生效
  ...
  /// pickerMode: [AuDateTimeRangePickerMode] 展示的 mode: date(DatePicker)、time(TimePicker)
  ...
  /// pickerTitleConfig: [AuPickerTitleConfig] Picker title 配置
  /// themeData: [AuPickerConfig] 主题配置
  static void showDatePicker(
    ...
    AuDateTimeRangePickerMode pickerMode = AuDateTimeRangePickerMode.date,
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  ...
  final AuDateTimeRangePickerMode pickerMode;
  ...
  _DatePickerRoute({
    ...
    this.dateFormat,
    this.pickerMode = AuDateTimeRangePickerMode.date,
  ...
  Widget build(BuildContext context) {
    ...
    switch (route.pickerMode) {
      case AuDateTimeRangePickerMode.date:
        pickerWidget = AuDateRangeWidget(
      ...
      case AuDateTimeRangePickerMode.time:
        pickerWidget = AuTimeRangeWidget(
          minDateTime: route.minDateTime,
          maxDateTime: route.maxDateTime,
