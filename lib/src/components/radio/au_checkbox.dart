...
class AuCheckbox extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return AuCheckboxState();
  }
}

class AuCheckboxState extends State<AuCheckbox> {
  ...
  @override
  void didUpdateWidget(covariant AuCheckbox oldWidget) {
  ...
  Widget build(BuildContext context) {
    return AuRadioCore(
      ...
      selectedImage:
          BrunoTools.getAssetImageWithBandColor(AuAsset.iconRadioMultiSelected),
      unselectedImage: BrunoTools.getAssetImage(AuAsset.iconRadioUnSelected),
      disSelectedImage:
          BrunoTools.getAssetImage(AuAsset.iconRadioDisableSingleSelected),
      disUnselectedImage:
          BrunoTools.getAssetImage(AuAsset.iconRadioDisableUnselected),
      onRadioItemClick: () {
        setState(() {
