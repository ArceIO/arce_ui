...
class AuRadioCore extends StatefulWidget {
  /// 标识当前Radio的Index
  ...
  @override
  _AuRadioCoreState createState() => _AuRadioCoreState();
}

class _AuRadioCoreState extends State<AuRadioCore> {
  ...
  @override
  void didUpdateWidget(AuRadioCore oldWidget) {
...
//        widget.radioType == AuRadioType.single
//            ? AuAsset.ICON_RADIO_SINGLE_SELECTED
//            : AuAsset.ICON_RADIO_MULTI_SELECTED);
//    Image unselectedImage = BrunoTools.getAssetImage(AuAsset.ICON_RADIO_UNSELECTED);
//    Image disSelectedImage = BrunoTools.getAssetImage(widget.radioType == AuRadioType.single
//        ? AuAsset.ICON_RADIO_DISABLE_SINGLE_SELECTED
//        : AuAsset.ICON_RADIO_DISABLE_MULTI_SELECTED);
//    Image disUnselectedImage = BrunoTools.getAssetImage(AuAsset.ICON_RADIO_DISABLE_UNSELECTED);
...
//          if (widget.radioType == AuRadioType.single) {
//            // 单选
