...
/// 滑动锚点组件
class AuAnchorTab extends StatefulWidget {
  /// TabBar的样式
  final AuAnchorTabBarStyle tabBarStyle;
  ...
  const AuAnchorTab(
      ...
      this.tabDivider,
      this.tabBarStyle = const AuAnchorTabBarStyle()});

  @override
  _AuScrollAnchorTabWidgetState createState() =>
      _AuScrollAnchorTabWidgetState();
}

class _AuScrollAnchorTabWidgetState extends State<AuAnchorTab>
  ...
  @override
  void didUpdateWidget(AuAnchorTab oldWidget) {
