...
///页面类型保罗了：标题、选择框
class AuFlatMoreSelection extends StatefulWidget {
  /// 数据源
  ...
  @override
  _AuFlatMoreSelectionState createState() => _AuFlatMoreSelectionState();
}

class _AuFlatMoreSelectionState extends State<AuFlatMoreSelection> {
  @override
...
class __FilterCommonTypeWidgetState extends State<_FilterCommonTypeWidget> {
  ...
  Widget _buildSingleTag(AuSelectionEntity data) {
    bool isDate = data.filterType == AuSelectionFilterType.date;
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            Text(AuIntl.of(context).localizedResource.more,
...
class __MoreRangeWidgetState extends State<_MoreRangeWidget> {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: <Widget>[
        _buildRangeField(AuIntl.of(context).localizedResource.minValue,
        ...
        _buildRangeField(AuIntl.of(context).localizedResource.maxValue,
