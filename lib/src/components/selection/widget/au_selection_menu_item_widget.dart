...
class AuSelectionMenuItemWidget extends StatelessWidget {
  /// 菜单项标题
  final String title;
                  ...
                  child: isHighLight
                      ? (active
                          ? BrunoTools.getAssetImageWithBandColor(
                              AuAsset.iconArrowUpSelect,
                              configId: themeData.configId)
                          : BrunoTools.getAssetImageWithBandColor(
                              AuAsset.iconArrowDownSelect))
                      : (active
                          ? BrunoTools.getAssetImageWithBandColor(
                              AuAsset.iconArrowUpSelect,
                              configId: themeData.configId)
                          : BrunoTools.getAssetImage(
                              AuAsset.iconArrowDownUnSelect)))
            ],
          ),
        ),
      ),
