...
/// ),
///
class AuStepLine extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _AuStepLineState();
  }
}

class _AuStepLineState extends State<AuStepLine> {
  @override
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        CustomPaint(
          painter: _AuStepLinePainter(
...
class _AuStepLinePainter extends CustomPainter {
