...
class AuTriangleIndicator extends Decoration {
  ...
  factory AuTriangleIndicator.fromBoxDecoration(BoxDecoration source) {
    ShapeBorder? shape;
    switch (source.shape) {
  ...
  @override
  AuTriangleIndicator? lerpFrom(Decoration? a, double t) {
    if (a is BoxDecoration) {
      return AuTriangleIndicator.lerp(
          AuTriangleIndicator.fromBoxDecoration(a), this, t);
    } else if (a == null || a is AuTriangleIndicator) {
      return AuTriangleIndicator.lerp(a as AuTriangleIndicator?, this, t);
    }
    return super.lerpFrom(a, t) as AuTriangleIndicator?;
  }

  @override
  AuTriangleIndicator? lerpTo(Decoration? b, double t) {
    if (b is BoxDecoration) {
      return AuTriangleIndicator.lerp(
          this, AuTriangleIndicator.fromBoxDecoration(b), t);
    } else if (b == null || b is AuTriangleIndicator) {
      return AuTriangleIndicator.lerp(this, b as AuTriangleIndicator?, t);
    }
    return super.lerpTo(b, t) as AuTriangleIndicator?;
  }

  static AuTriangleIndicator? lerp(
      AuTriangleIndicator? a, AuTriangleIndicator? b, double t) {
...
/// An object that paints a [AuTriangleIndicator] into a canvas.
class _TriangleDecorationPainter extends BoxPainter {
  ...
  final AuTriangleIndicator _decoration;
