...
class AuSubSwitchTitle extends StatefulWidget {
  /// 标题的文案列表
  ...
  @override
  _AuSubSwitchTitleState createState() => _AuSubSwitchTitleState();
}

class _AuSubSwitchTitleState extends State<AuSubSwitchTitle>
  ...
  @override
  void didUpdateWidget(AuSubSwitchTitle oldWidget) {
