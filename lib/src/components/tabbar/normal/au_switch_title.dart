...
class AuSwitchTitle extends StatefulWidget {
  /// 标题的文案列表
  ...
  @override
  _AuSwitchTitleState createState() => _AuSwitchTitleState();
}

class _AuSwitchTitleState extends State<AuSwitchTitle>
  ...
  @override
  void didUpdateWidget(AuSwitchTitle oldWidget) {
