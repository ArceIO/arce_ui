import 'package:arce_ui/src/components/tag/au_tag_custom.dart';
...
///
/// 状态标签是在自定义标签的基础上[AuTagCustom],进行具体化实现：圆角固定为2，构造参数减少等
///
/// 如果有其他更多自定义的诉求 请参考[AuTagCustom]
///
/// 其他标签的实现
/// * [AuTagCustom], 高度自定义的通用标签
///
class AuStateTag extends StatelessWidget {
