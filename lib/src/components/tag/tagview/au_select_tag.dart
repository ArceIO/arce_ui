...
class AuSelectTag extends StatefulWidget {
  /// 展示的标签列表
  ...
  AuSelectTag({
    ...
    themeData = themeData!.merge(AuTagConfig(
        ...
        selectTagTextStyle: AuTextStyle.withStyle(selectedTagTextStyle),
        tagWidth: tagWidth,
        tagHeight: tagHeight,
  ...
  @override
  _AuSelectTagState createState() => _AuSelectTagState();
}

class _AuSelectTagState extends State<AuSelectTag> {
  List<bool> _tagState = [];
  ...
  @override
  void didUpdateWidget(AuSelectTag oldWidget) {
