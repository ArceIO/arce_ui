...
class AuThemeConfigurator {
  AuThemeConfigurator._() {
    _checkAndInitBrunoConfig();
  }

  static final AuThemeConfigurator _instance = AuThemeConfigurator._();

  static AuThemeConfigurator get instance {
    return _instance;
  }

  Map<String, AuAllThemeConfig> globalConfig = <String, AuAllThemeConfig>{};
  ...
  AuAllThemeConfig getConfig({String configId = GLOBAL_CONFIG_ID}) {
    AuAllThemeConfig? allThemeConfig = globalConfig[configId] ??
  ...
  void _checkAndInitBrunoConfig() {
    if (!isBrunoConfig()) {
      globalConfig[BRUNO_CONFIG_ID] = AuDefaultConfigUtils.defaultAllConfig;
    }
  }
}
