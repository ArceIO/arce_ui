...
/// 描述: 全局配置
/// 配置属性：色值、字体大小、间距、圆角
class AuCommonConfig extends AuBaseConfig {
  AuCommonConfig({
    Color? brandPrimary,
...
///////////////////////////////////////////////////////////////////////////////
  ...
  Color get brandPrimary =>
      _brandPrimary ?? AuDefaultConfigUtils.defaultCommonConfig.brandPrimary;

  Color get brandPrimaryTap =>
      _brandPrimaryTap ??
      AuDefaultConfigUtils.defaultCommonConfig.brandPrimaryTap;

  Color get brandSuccess =>
      _brandSuccess ?? AuDefaultConfigUtils.defaultCommonConfig.brandSuccess;

  Color get brandWarning =>
      _brandWarning ?? AuDefaultConfigUtils.defaultCommonConfig.brandWarning;

  Color get brandError =>
      _brandError ?? AuDefaultConfigUtils.defaultCommonConfig.brandError;

  Color get brandImportant =>
      _brandImportant ??
      AuDefaultConfigUtils.defaultCommonConfig.brandImportant;

  Color get brandImportantValue =>
      _brandImportantValue ??
      AuDefaultConfigUtils.defaultCommonConfig.brandImportantValue;

  Color get brandAuxiliary =>
      _brandAuxiliary ??
      AuDefaultConfigUtils.defaultCommonConfig.brandAuxiliary;

  Color get colorTextBase =>
      _colorTextBase ?? AuDefaultConfigUtils.defaultCommonConfig.colorTextBase;

  Color get colorTextImportant =>
      _colorTextImportant ??
      AuDefaultConfigUtils.defaultCommonConfig.colorTextImportant;

  Color get colorTextBaseInverse =>
      _colorTextBaseInverse ??
      AuDefaultConfigUtils.defaultCommonConfig.colorTextBaseInverse;

  Color get colorTextSecondary =>
      _colorTextSecondary ??
      AuDefaultConfigUtils.defaultCommonConfig.colorTextSecondary;

  Color get colorTextDisabled =>
      _colorTextDisabled ??
      AuDefaultConfigUtils.defaultCommonConfig.colorTextDisabled;

  Color get colorTextHint =>
      _colorTextHint ?? AuDefaultConfigUtils.defaultCommonConfig.colorTextHint;

  Color get colorLink =>
      _colorLink ?? AuDefaultConfigUtils.defaultCommonConfig.colorLink;

  Color get fillBase =>
      _fillBase ?? AuDefaultConfigUtils.defaultCommonConfig.fillBase;

  Color get fillBody =>
      _fillBody ?? AuDefaultConfigUtils.defaultCommonConfig.fillBody;

  Color get fillMask =>
      _fillMask ?? AuDefaultConfigUtils.defaultCommonConfig.fillMask;

  Color get borderColorBase =>
      _borderColorBase ??
      AuDefaultConfigUtils.defaultCommonConfig.borderColorBase;

  Color get dividerColorBase =>
      _dividerColorBase ??
      AuDefaultConfigUtils.defaultCommonConfig.dividerColorBase;

  double get fontSizeBebas =>
      _fontSizeBebas ?? AuDefaultConfigUtils.defaultCommonConfig.fontSizeBebas;

  double get fontSizeHeadLg =>
      _fontSizeHeadLg ??
      AuDefaultConfigUtils.defaultCommonConfig.fontSizeHeadLg;

  double get fontSizeHead =>
      _fontSizeHead ?? AuDefaultConfigUtils.defaultCommonConfig.fontSizeHead;

  double get fontSizeSubHead =>
      _fontSizeSubHead ??
      AuDefaultConfigUtils.defaultCommonConfig.fontSizeSubHead;

  double get fontSizeBase =>
      _fontSizeBase ?? AuDefaultConfigUtils.defaultCommonConfig.fontSizeBase;

  double get fontSizeCaption =>
      _fontSizeCaption ??
      AuDefaultConfigUtils.defaultCommonConfig.fontSizeCaption;

  double get fontSizeCaptionSm =>
      _fontSizeCaptionSm ??
      AuDefaultConfigUtils.defaultCommonConfig.fontSizeCaptionSm;

  double get radiusXs =>
      _radiusXs ?? AuDefaultConfigUtils.defaultCommonConfig.radiusXs;

  double get radiusSm =>
      _radiusSm ?? AuDefaultConfigUtils.defaultCommonConfig.radiusSm;

  double get radiusMd =>
      _radiusMd ?? AuDefaultConfigUtils.defaultCommonConfig.radiusMd;

  double get radiusLg =>
      _radiusLg ?? AuDefaultConfigUtils.defaultCommonConfig.radiusLg;

  double get borderWidthSm =>
      _borderWidthSm ?? AuDefaultConfigUtils.defaultCommonConfig.borderWidthSm;

  double get borderWidthMd =>
      _borderWidthMd ?? AuDefaultConfigUtils.defaultCommonConfig.borderWidthMd;

  double get borderWidthLg =>
      _borderWidthLg ?? AuDefaultConfigUtils.defaultCommonConfig.borderWidthLg;

  double get hSpacingXs =>
      _hSpacingXs ?? AuDefaultConfigUtils.defaultCommonConfig.hSpacingXs;

  double get hSpacingSm =>
      _hSpacingSm ?? AuDefaultConfigUtils.defaultCommonConfig.hSpacingSm;

  double get hSpacingMd =>
      _hSpacingMd ?? AuDefaultConfigUtils.defaultCommonConfig.hSpacingMd;

  double get hSpacingLg =>
      _hSpacingLg ?? AuDefaultConfigUtils.defaultCommonConfig.hSpacingLg;

  double get hSpacingXl =>
      _hSpacingXl ?? AuDefaultConfigUtils.defaultCommonConfig.hSpacingXl;

  double get hSpacingXxl =>
      _hSpacingXxl ?? AuDefaultConfigUtils.defaultCommonConfig.hSpacingXxl;

  double get vSpacingXs =>
      _vSpacingXs ?? AuDefaultConfigUtils.defaultCommonConfig.vSpacingXs;

  double get vSpacingSm =>
      _vSpacingSm ?? AuDefaultConfigUtils.defaultCommonConfig.vSpacingSm;

  double get vSpacingMd =>
      _vSpacingMd ?? AuDefaultConfigUtils.defaultCommonConfig.vSpacingMd;

  double get vSpacingLg =>
      _vSpacingLg ?? AuDefaultConfigUtils.defaultCommonConfig.vSpacingLg;

  double get vSpacingXl =>
      _vSpacingXl ?? AuDefaultConfigUtils.defaultCommonConfig.vSpacingXl;

  double get vSpacingXxl =>
      _vSpacingXxl ?? AuDefaultConfigUtils.defaultCommonConfig.vSpacingXxl;

  double get iconSizeXxs =>
      _iconSizeXxs ?? AuDefaultConfigUtils.defaultCommonConfig.iconSizeXxs;

  double get iconSizeXs =>
      _iconSizeXs ?? AuDefaultConfigUtils.defaultCommonConfig.iconSizeXs;

  double get iconSizeSm =>
      _iconSizeSm ?? AuDefaultConfigUtils.defaultCommonConfig.iconSizeSm;

  double get iconSizeMd =>
      _iconSizeMd ?? AuDefaultConfigUtils.defaultCommonConfig.iconSizeMd;

  double get iconSizeLg =>
      _iconSizeLg ?? AuDefaultConfigUtils.defaultCommonConfig.iconSizeLg;
