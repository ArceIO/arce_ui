...
import 'package:arce_ui/src/utils/css/au_util.dart';
import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';
import 'package:xml/xml_events.dart' as xml;

/// 超链接的点击回调
typedef AuHyperLinkCallback = void Function(String text, String? url);
...
class AuConvert {
  ...
  AuConvert(
    String cssContent, {
    AuHyperLinkCallback? linkCallBack,
  ...
  /// 超链接的点击回调
  AuHyperLinkCallback? _linkCallBack;
              ...
              switch (attr.name) {
                case 'color':
                  textStyle = textStyle.apply(
                    color: AuConvertUtil.generateColorByString(attr.value),
                  );
                  break;
                case 'weight':
                  FontWeight fontWeight =
                      AuConvertUtil.generateFontWidgetByString(attr.value);
                  textStyle = textStyle.apply(
                ...
                case 'size':
                  textStyle = textStyle.apply(
                    fontSizeDelta:
                        AuConvertUtil.generateFontSize(attr.value) - 13,
                  );
                  break;
              }
            }
